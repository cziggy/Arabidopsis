Iterations_max = 1000000000;
Iterations = 0;
hits = 0;
hits_check_1 = 0;
Branching0 = zeros(1,Iterations_max);
Branching1 = zeros(1,Iterations_max);
Growth0 = zeros(1,Iterations_max);
Growth1 = zeros(1,Iterations_max);
Lambda = zeros(1,Iterations_max);
...
while Iterations < Iterations_max
    ...
    Number_of_Daughters_Data_2 = [9 7 11 12 13 19 15 9 16 12];
